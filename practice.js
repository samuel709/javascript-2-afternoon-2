...
function evenFinder(nums){
  var arr = nums.filter(function(val){return val % 2 === 0});
  return arr;
}
...
function divider(numbersArray){
  var evensArray = numbersArray.filter(function(val){return val % 2 === 0});
  var oddsArray = numbersArray.filter(function(val){return val % 2 !== 0});
  numbersArray.splice(0, numbersArray.length, evensArray, oddsArray);
  return numbersArray;
}
...
//Code Here
var user2 = {
  name: "Samuel Urquhart",
  email: "itsasecret@secret.com",
  password: "iLoveDrPepper",
  username: "DrP4Life"
}

var user3 = {
  name: "Frodo Baggins",
  email: "giveusthering@mordor.com",
  password: "GollumSux",
  username: "CarriedBySamwise"
}
